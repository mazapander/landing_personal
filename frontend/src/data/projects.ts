...
export const projects = [
  {
    ...
    description: 'Una herramienta para entender si una vivienda está cara respecto a su zona y poner la decisión en contexto con datos públicos.',
    url: 'https://github.com/mazapander/IAcomprapisos',
    status: 'Building',
    public: true,
  ...
  },
  {
    id: 'motion-lab',
    title: 'Motion Lab',
    description: 'Estoy probando computer vision para medir acciones de baloncesto y convertir vídeo en datos que se puedan revisar.',
    url: '/lab/',
    status: 'Testing',
    public: false,
    stack: ['python', 'pytorch', 'UltralyticsYOLO'],
  },
  {
    id: 'stats-feb',
    title: 'StatsFEB',
    description: 'Ingesta, histórico y analytics para competiciones FEB: partidos, jugadores, boxscores y contexto más allá de la estadística básica.',
    url: '/lab/',
    status: 'Building',
    public: false,
    stack: ['python', 'fastapi', 'postgresql', 'react', 'docker'],
  },
  {
    ...
    public: true,
    stack: ['typescript', 'react', 'postgresql', 'fastapi', 'docker', 'langchain'],
  },
  {
    id: 'advanced-feb-basketball-analytics',
    title: 'Advanced FEB Basketball Analytics Platform',
    description: 'Sistema para scraping, modelado de datos e informes avanzados sobre partidos y jugadores de baloncesto, con histórico de temporadas FEB.',
    url: 'https://github.com/mazapander',
    status: 'Portfolio',
    public: true,
    stack: ['python', 'sql', 'postgresql', 'docker', 'fastapi'],
  },
  {
    ...
    public: false,
    stack: ['python', 'langchain', 'docker', 'elevenlabs', 'whisper'],
  },
  {
  ...
  },
  {
    ...
    status: 'Público',
    public: true,
    stack: ['codex', 'claude code', 'python'],
  },
  {
    id: 'personal-website',
    title: 'Personal Website & Landing',
    description: 'Esta web: un espacio para proyectos, experimentos, notas y trabajo en curso, desplegado en infraestructura propia.',
    url: 'https://github.com/mazapander/landing_personal',
    status: 'Público',
    public: true,
    stack: ['astro', 'typescript', 'react', 'docker'],
  },
] satisfies Project[]
